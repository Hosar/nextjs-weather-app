...
function _webpackFinal() {
  _webpackFinal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var config,
        options,
        _config$module,
        module,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newConfig = _objectSpread(_objectSpread({}, config), {}, {
              module: _objectSpread(_objectSpread({}, module), {}, {
                rules: _toConsumableArray(module.rules || [])
              })
            });
            cssLoaderRule = newConfig.module.rules.find(function (rule) {
              var _rule$test;

              return (rule === null || rule === void 0 ? void 0 : (_rule$test = rule.test) === null || _rule$test === void 0 ? void 0 : _rule$test.toString()) === "/\\.css$/";
            });
          ...
          case 12:
            if (cssLoaderRule) {
              newConfig.module.rules.push(_objectSpread(_objectSpread({}, cssLoaderRule), {}, {
                test: /\.module\.css$/,
